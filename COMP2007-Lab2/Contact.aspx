<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="COMP2007_Lab2.Contact" %>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <address>
                            <strong>Himannshu Patel</strong><br>
                            205-335 Missisaga st<br>
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <label class="control-label" for="EmailTextBox">Email ID</label>
                ...
                <div class="form-group">
                    <label class="control-label" for="MessageTextBox">Enter Message</label>
